...
const demoPasswordHash = '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LeblUcYbhyL4K5Qhm';
...
console.log('Demo user created with password hash:', demoPasswordHash.substring(0, 20) + '...');
